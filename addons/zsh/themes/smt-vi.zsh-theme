...
# http://superuser.com/a/478563/31909
...
PROMPT='
%{$fg_bold[blue]%}%m%{$reset_color%} 福 %{$fg[cyan]%}%~ %{$reset_color%}$(git_prompt_short_sha)$(git_prompt_info)
$vim_mode%{$fg[red]%}%!%{$reset_color%} $(prompt_char) : '
